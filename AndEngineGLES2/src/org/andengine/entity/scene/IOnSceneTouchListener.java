 ...
 * dispatched to a {@link Scene}. The callback will be invoked after all
 * {@link ITouchArea}s have been checked and none consumed the
 * {@link TouchEvent}.
 * 
 * (c) Zynga 2012
 * 
...
public interface IOnSceneTouchListener {
	 ...
	 * 
	 * @param pScene
	 *            The {@link Scene} that the {@link TouchEvent} has been
	 *            dispatched to.
	 * @param pSceneTouchEvent
	 *            The {@link TouchEvent} object containing full information
	 *            about the event.
	 * 
	 * @return <code>true</code> if this {@link IOnSceneTouchListener} has
