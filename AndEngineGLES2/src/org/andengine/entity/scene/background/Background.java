...
public class Background implements IBackground {
	 ...
	 * @param pGreen
	 *            The green color value. Should be between 0.0 and 1.0,
	 *            inclusive.
	 * @param pBlue
	 *            The blue color value. Should be between 0.0 and 1.0,
	 *            inclusive.
	 */
	@Override
	 ...
	 *            inclusive.
	 * @param pAlpha
	 *            The alpha color value. Should be between 0.0 and 1.0,
	 *            inclusive.
	 */
	@Override
	...
	public void onDraw(final GLState pGLState, final Camera pCamera) {
		if (this.mColorEnabled) {
			...
			GLES20.glClear(GLES20.GL_COLOR_BUFFER_BIT); // TODO Does this cause
														// problems when
														// multisampling?
		}
	}
