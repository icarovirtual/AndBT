...
/**
 * Sets the blend function used to draw the {@link Particle} during its
 * lifespan. Only applicable to {@link Shape}s.
 * 
...
public class BlendFunctionParticleInitializer<T extends IShape> implements IParticleInitializer<T> {
	...
	/**
	 * Blend function set for each spawned {@link Particle}. Use {@link GLES20}
	 * constants for setting functions.
	 */
