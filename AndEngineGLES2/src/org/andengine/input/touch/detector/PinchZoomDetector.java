...
public class PinchZoomDetector extends BaseDetector {
	...
	/**
	 * When {@link PinchZoomDetector#isZooming()} this method will call through
	 * to
	 * {@link IPinchZoomDetectorListener#onPinchZoomFinished(PinchZoomDetector, TouchEvent, float)}
	 * .
	 */
	@Override
	public void reset() {
