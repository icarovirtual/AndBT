...
public interface IVertexBufferObject extends IDisposable {
	...
	/**
	 * Mark this {@link VertexBufferObject} as not not loaded to hardware. It
	 * will reload itself to hardware when it gets used again.
	 */
	...
	/**
	 * Mark this {@link VertexBufferObject} dirty so it gets updated on the
	 * hardware.
	 */
	public void setDirtyOnHardware();

	/**
	 * @return the number of <code>float</code>s that fit into this
	 *         {@link IVertexBufferObject}.
	 */
	public int getCapacity();

	/**
	 * @return the number of <code>byte</code>s that fit into this
	 *         {@link IVertexBufferObject}.
	 */
	...
	/**
	 * @return the number of <code>byte</code>s that are allocated on the native
	 *         heap (through direct {@link ByteBuffer}s).
	 */
